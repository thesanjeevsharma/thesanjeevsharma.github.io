...
var Navbar = function Navbar() {
  ...
  return __jsx("nav", {
    ...
    className: router.pathname.includes('projects') ? 'text-purple-400' : 'text-white cursor-pointer',
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20,
    ...
    className: router.pathname.includes('courses') ? 'text-green-400' : 'text-white  cursor-pointer',
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 31,
...
//# sourceMappingURL=projects.js.5cfdc334c135559fabd8.hot-update.js.map