...
var Navbar = function Navbar() {
  ...
  console.log();
  return __jsx("nav", {
    className: "h-16 px-4 fixed bg-gray w-full flex items-center justify-between z-10",
    __self: _this,
    __source: {
    ...
    className: "grid grid-cols-2 gap-4 lg:text-lg",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 18,
...
//# sourceMappingURL=projects.js.b0bb76b90f437ba857c5.hot-update.js.map